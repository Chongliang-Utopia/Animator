...
public class ShapeFactoryTest {
  ...
  public void buildShape() {
    IShape rec = ShapeFactory.buildShape("R", ShapeType.RECTANGLE,
    ...
    IShape oval = ShapeFactory.buildShape("O", ShapeType.OVAL,
  ...
  public void nullType() {
    IShape oval = ShapeFactory.buildShape("R", null,
            new ColorType(255, 139, 234), new Position2D(500.0, 100.0),
            60.0, 30.0, 6, 100);
  }
  ...
  public void invalidAppearDisappear() {
    IShape oval = ShapeFactory.buildShape("R", ShapeType.OVAL,
            new ColorType(255, 139, 234), new Position2D(200.0, 200.0),
            50.0, 100.0, 50, 2);
  }
