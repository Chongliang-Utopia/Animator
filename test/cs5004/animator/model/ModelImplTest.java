...
public class ModelImplTest {
  ...
  public void testGetUpdatedShapeAtGivenTime1() {
    ...
    expected.add(new Rectangle("R", ShapeType.RECTANGLE,
        new ColorType(0, 0, 0), new Position2D(0, 0),
        1.0, 1.0, 1, 100));
    List<IReadOnlyShapes> actual = model1.getUpdatedShapeAtGivenTime(1);
    assertEquals(expected, model1.getUpdatedShapeAtGivenTime(50));
  }
}