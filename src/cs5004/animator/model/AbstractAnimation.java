...
public abstract class AbstractAnimation {
    ...
    /**
     * Calculate the current state according the start state, end state in the given
     * time. The state could represent any value that the shape has, such as its width,
     * height, RGB individual values, etc.
